...
namespace GraphProcessor
{
    ...
    public abstract class BaseNode
    {
        ...
        /// </summary>
        private NodeInputPortContainer inputPorts;

        /// <summary>
        /// Container of output ports
        /// </summary>
        private NodeOutputPortContainer outputPorts;
        ...
        [HideInInspector]
        public Dictionary<Type, CustomPortTypeBehaviorDelegate> customPortTypeBehaviorMap =
        ...
        public NodeInputPortContainer GetInputPorts()
        {
            if (this.inputPorts == null)
            {
                this.inputPorts = new NodeInputPortContainer(this);
            }

            return this.inputPorts;
        }

        public NodeOutputPortContainer GetOutputPorts()
        {
            if (this.outputPorts == null)
            {
                this.outputPorts = new NodeOutputPortContainer(this);
            }
        ...
        [HideInInspector]
        public Stack<PortUpdate> fieldsToUpdate = new Stack<PortUpdate>();
        [HideInInspector]
        public HashSet<PortUpdate> updatedFields = new HashSet<PortUpdate>();
        ...
        public void InitializeInOutDatas()
        {
